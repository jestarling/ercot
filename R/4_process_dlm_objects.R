...
#Output R objects.
saveRDS(y_all,'Data/dlm_objects/dlm_y_allzones.rda')
saveRDS(F_all,'Data/dlm_objects/dlm_F_allzones.rda')
saveRDS(G_all,'Data/dlm_objects/dlm_G_allzones.rda')
saveRDS(datetime_info,'Data/dlm_objects/dlm_datetime_info.rda')
