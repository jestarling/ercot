...
out = paste(path,'/R/Output/SmallScaleFitTest/',sep='')
...
datetime_info = readRDS('Data/dlm_objects/dlm_datetime_info.rda')
...
pdf(paste(out,"01_COAST_Window 9_Raw Data (y).pdf",sep=''), width=12, height=6)
	par(mfrow=c(1,2))
...
pdf(paste(out,"02_Prior_v_w_densities.pdf",sep=''), height=4, width=8)
	par(mfrow=c(1,2))
...
pdf(paste(out,"03_COAST_Win9_Scaled_InSampleFit.pdf",sep=''), width=12,height=6)
...
pdf(paste(out,"05_COAST_Win9_Bushr and Temp Trace.pdf",sep=''), width=18, height=12)
...
#Plot each hour-of-day dummy var over time.
pdf(paste(out,"06_COAST_Win9_Hourly Dummy Trace.pdf",sep=''), width=18, height=12)
...
pdf(paste(out,"Insamp_Errors_Autocorrelation.pdf",sep=''), width=10, height=8)
	acf(err.insamp)
dev.off()
...
pdf(paste(out,"04a_COAST_Win9_Forecast.pdf",sep=''), width=12, height=6)
...
pdf(paste(out,"04b_COAST_Win9_Forecast_Rescaled.pdf",sep=''), width=12, height=6)
...
pdf(paste(out,"InsampMSE_01_COAST_Win9_Boxplot By Day for ea Hr.pdf",sep=''), width=15, height=25)
...
pdf(paste(out,"InsampMSE_02_COAST_Win9_Boxplot By Hr for ea Day.pdf",sep=''), width=15, height=25)
