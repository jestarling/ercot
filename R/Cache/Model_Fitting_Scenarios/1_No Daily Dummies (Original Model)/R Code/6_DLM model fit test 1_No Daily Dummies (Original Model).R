...
out = '/Users/jennstarling/UTAustin/Research/ercot/R Code/Model_Fitting_Scenarios/1_No Daily Dummies (Original Model)/Figures/'
...
#Read in data.
y_all = readRDS('R Code/Model_Fitting_Scenarios/1_No Daily Dummies (Original Model)/R Data Objects/dlm_y_allzones.rda')
F_all = readRDS('R Code/Model_Fitting_Scenarios/1_No Daily Dummies (Original Model)/R Data Objects/dlm_F_allzones.rda')
G_all = readRDS('R Code/Model_Fitting_Scenarios/1_No Daily Dummies (Original Model)/R Data Objects/dlm_G_allzones.rda')
datetime_info = readRDS('R Code/Model_Fitting_Scenarios/1_No Daily Dummies (Original Model)/R Data Objects/dlm_datetime_info.rda')
