...
out = '/Users/jennstarling/UTAustin/Research/ercot/R Code/Model_Fitting_Scenarios/7_With Daily Dummies and Day_x_Hr Interaction/Figures/'
...
#Read in data.
y_all = readRDS('R Code/Model_Fitting_Scenarios/7_With Daily Dummies and Day_x_Hr Interaction/R Data Objects/dlm_y_allzones.rda')
F_all = readRDS('R Code/Model_Fitting_Scenarios/7_With Daily Dummies and Day_x_Hr Interaction/R Data Objects/dlm_F_allzones.rda')
G_all = readRDS('R Code/Model_Fitting_Scenarios/7_With Daily Dummies and Day_x_Hr Interaction/R Data Objects/dlm_G_allzones.rda')
datetime_info = readRDS('R Code/Model_Fitting_Scenarios/7_With Daily Dummies and Day_x_Hr Interaction/R Data Objects/dlm_datetime_info.rda')
...
#--------------------------------------------------------
#   Trace Plots: Hr_x_Daily Interaction Dummies
#	Plot each variable's trace over time.   
#--------------------------------------------------------
...
system("say DLM script number 7 has completed!")
