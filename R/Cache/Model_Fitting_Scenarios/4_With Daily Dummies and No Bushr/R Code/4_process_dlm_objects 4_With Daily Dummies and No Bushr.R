...
for (i in 1:8){
	...
	F[[i]] = as.matrix(cbind.data.frame(F.int,F.temp,F.temp2,F.hrdummies,F.daydummies)) #***********
...
#Output R objects.
saveRDS(y_all,'R Code/Model_Fitting_Scenarios/4_With Daily Dummies (Time Invariant) and No Bushr/R Data Objects/dlm_y_allzones.rda')
saveRDS(F_all,'R Code/Model_Fitting_Scenarios/4_With Daily Dummies (Time Invariant) and No Bushr/R Data Objects/dlm_F_allzones.rda')
saveRDS(G_all,'R Code/Model_Fitting_Scenarios/4_With Daily Dummies (Time Invariant) and No Bushr/R Data Objects/dlm_G_allzones.rda')
saveRDS(datetime_info,'R Code/Model_Fitting_Scenarios/4_With Daily Dummies (Time Invariant) and No Bushr/R Data Objects/dlm_datetime_info.rda')
