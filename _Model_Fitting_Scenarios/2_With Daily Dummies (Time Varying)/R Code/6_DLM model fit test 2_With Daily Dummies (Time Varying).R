...
out = '/Users/jennstarling/UTAustin/Research/ercot/R Code/Model_Fitting_Scenarios/2_With Daily Dummies (Time Varying)/Figures/'
...
#Read in data.
y_all = readRDS('R Code/Model_Fitting_Scenarios/2_With Daily Dummies (Time Varying)/R Data Objects/dlm_y_allzones.rda')
F_all = readRDS('R Code/Model_Fitting_Scenarios/2_With Daily Dummies (Time Varying)/R Data Objects/dlm_F_allzones.rda')
G_all = readRDS('R Code/Model_Fitting_Scenarios/2_With Daily Dummies (Time Varying)/R Data Objects/dlm_G_allzones.rda')
datetime_info = readRDS('R Code/Model_Fitting_Scenarios/2_With Daily Dummies (Time Varying)/R Data Objects/dlm_datetime_info.rda')
...
system("say DLM script number 2 has completed!")
