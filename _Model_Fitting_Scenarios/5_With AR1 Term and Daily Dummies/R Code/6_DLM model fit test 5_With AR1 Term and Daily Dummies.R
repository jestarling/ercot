...
out = '/Users/jennstarling/UTAustin/Research/ercot/R Code/Model_Fitting_Scenarios/5_With AR1 Term and Daily Dummies/Figures/'
...
#Read in data.
y_all = readRDS('R Code/Model_Fitting_Scenarios/5_With AR1 Term and Daily Dummies/R Data Objects/dlm_y_allzones.rda')
F_all = readRDS('R Code/Model_Fitting_Scenarios/5_With AR1 Term and Daily Dummies/R Data Objects/dlm_F_allzones.rda')
G_all = readRDS('R Code/Model_Fitting_Scenarios/5_With AR1 Term and Daily Dummies/R Data Objects/dlm_G_allzones.rda')
datetime_info = readRDS('R Code/Model_Fitting_Scenarios/5_With AR1 Term and Daily Dummies/R Data Objects/dlm_datetime_info.rda')
...
system('say DLM script 5 has completed!')
