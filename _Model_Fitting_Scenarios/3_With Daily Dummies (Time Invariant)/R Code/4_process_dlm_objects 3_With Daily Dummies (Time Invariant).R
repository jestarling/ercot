...
#Output R objects.
saveRDS(y_all,'R Code/Model_Fitting_Scenarios/3_With Daily Dummies (Time Invariant)/R Data Objects/dlm_y_allzones.rda')
saveRDS(F_all,'R Code/Model_Fitting_Scenarios/3_With Daily Dummies (Time Invariant)/R Data Objects/dlm_F_allzones.rda')
saveRDS(G_all,'R Code/Model_Fitting_Scenarios/3_With Daily Dummies (Time Invariant)/R Data Objects/dlm_G_allzones.rda')
saveRDS(datetime_info,'R Code/Model_Fitting_Scenarios/3_With Daily Dummies (Time Invariant)/R Data Objects/dlm_datetime_info.rda')
