...
out = '/Users/jennstarling/UTAustin/Research/ercot/R Code/Model_Fitting_Scenarios/3_With Daily Dummies (Time Invariant)/Figures/'

#Load functions.
source('R Code/JS_DLM_FUNCTIONS.R')
sourceCpp(file='R Code/Model_Fitting_Scenarios/3_With Daily Dummies (Time Invariant)/R Code/JS_DLM_FUNCTIONS_ConstantDailies.cpp')
...
#Read in data.
y_all = readRDS('R Code/Model_Fitting_Scenarios/3_With Daily Dummies (Time Invariant)/R Data Objects/dlm_y_allzones.rda')
F_all = readRDS('R Code/Model_Fitting_Scenarios/3_With Daily Dummies (Time Invariant)/R Data Objects/dlm_F_allzones.rda')
G_all = readRDS('R Code/Model_Fitting_Scenarios/3_With Daily Dummies (Time Invariant)/R Data Objects/dlm_G_allzones.rda')
datetime_info = readRDS('R Code/Model_Fitting_Scenarios/3_With Daily Dummies (Time Invariant)/R Data Objects/dlm_datetime_info.rda')
...
ysig = sd(y)	#Save sd for un-scaling later.
...
system('say DLM script 3 has completed!')
