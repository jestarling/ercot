...
out = '/Users/jennstarling/UTAustin/Research/ercot/R Code/Model_Fitting_Scenarios/4_With Daily Dummies and No Bushr/Figures/'
...
#Read in data.
y_all = readRDS('R Code/Model_Fitting_Scenarios/4_With Daily Dummies and No Bushr/R Data Objects/dlm_y_allzones.rda')
F_all = readRDS('R Code/Model_Fitting_Scenarios/4_With Daily Dummies and No Bushr/R Data Objects/dlm_F_allzones.rda')
G_all = readRDS('R Code/Model_Fitting_Scenarios/4_With Daily Dummies and No Bushr/R Data Objects/dlm_G_allzones.rda')
datetime_info = readRDS('R Code/Model_Fitting_Scenarios/4_With Daily Dummies and No Bushr/R Data Objects/dlm_datetime_info.rda')
...
pdf(paste(out,"05_COAST_Win9_Bushr and Temp Trace.pdf"), width=18, height=12)
	...
	par(mfrow=c(1,2),oma=c(1,1,0,0) + .1, mar=c(0,0,1,1)+1)
...
system('say DLM script 4 has completed!')
