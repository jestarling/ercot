...
p = 28			#Num predictors - adjusted to add autoregressive term.
...
for (i in 1:8){
	...
	F[[i]] = as.matrix(cbind.data.frame(F.int,F.temp,F.temp2,F.holiday,ar1=F.ar1,F.hrdummies))
}
...
#Output R objects.
saveRDS(y_all,'R Code/Model_Fitting_Scenarios/6_With AR1 Term and No Daily Dummies/R Data Objects/dlm_y_allzones.rda')
saveRDS(F_all,'R Code/Model_Fitting_Scenarios/6_With AR1 Term and No Daily Dummies/R Data Objects/dlm_F_allzones.rda')
saveRDS(G_all,'R Code/Model_Fitting_Scenarios/6_With AR1 Term and No Daily Dummies/R Data Objects/dlm_G_allzones.rda')
saveRDS(datetime_info,'R Code/Model_Fitting_Scenarios/6_With AR1 Term and No Daily Dummies/R Data Objects/dlm_datetime_info.rda')
